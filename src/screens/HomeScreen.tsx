...
const BottomNav = ({
  ...
  <View className="flex-row justify-around items-center h-16 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700">
    ...
    >
      ...
      <Text className="text-xs text-slate-600 dark:text-slate-400">Wi-Fi</Text>
    </TouchableOpacity>
    <TouchableOpacity
      className="items-center"
      onPress={() => onNavigate('VisaFree')}
    >
      <Ionicons name="earth-outline" size={24} color="#10B981" />
      <Text className="text-xs text-slate-600 dark:text-slate-400">Visa</Text>
    </TouchableOpacity>
    <TouchableOpacity
      className="items-center"
